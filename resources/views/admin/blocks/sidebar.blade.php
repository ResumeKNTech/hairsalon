<aside class="main-sidebar sidebar-light-primary elevation-4" style="background:rgb(204, 204, 204)">
    ...
    <div class="sidebar">
        ...
        <div class="a">
            <div class="image" style="color:aliceblue">
                <div class="image" style="color:rgb(5, 5, 5); border-radius:20%;text-align:center">
                    <img width="90" src="{{ asset('upload/' . Auth::user()->file) }}" alt="User Image">
                    <br>
        ...
        <!-- /.sidebar-menu -->
        <div class="info" style="display:flex; justify-content:center; margin-top:50px">
            <a href="{{ route('logout') }}"><i class="fa-solid fa-up-right-from-square"> Đăng Xuất </i></a>
        </div>
    </div>
